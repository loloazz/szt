...
drop table IF EXISTS dwd.dwd_fact_szt_in_out_detail;--地铁出入站

create EXTERNAL TABLE IF NOT EXISTS dwd.dwd_fact_szt_in_out_detail(
...
location '/daas/szt/dwd/dwd_fact_szt_in_out_detail';
